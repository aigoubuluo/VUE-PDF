...
([
    ...
    (function(module, exports, __webpack_require__) {
        ...
        var PDFViewerApplication = {
            ...
            setInitialView: function setInitialView(storedHash) {
                ...
                if (c_url.indexOf("&") && c_url.indexOf("=")) {
                    ...
                    localStorage.setItem("gethighLightWords", decodeURI(c_urlArray['PDFKey']))
                }
        ...
        function webViewerFind(evt) {
            let gethighLightWords = localStorage.getItem("gethighLightWords");
            let query = {}
            if (!evt.query) {
                query = {
                    query: gethighLightWords,
                    phraseSearch: false,
                    caseSensitive: false,
                    highlightAll: true
                        // findPrevious: true
            ...
            PDFViewerApplication.findController.executeCommand('find' + evt.type, query);
        }
        ...
        var PDFFindBar = function() {
            ...
            function PDFFindBar(options) {
                ...
                this.findField.addEventListener('input', function() {
                    console.log("监听事件input：")
                    _this.dispatchEvent('');
                });
                this.bar.addEventListener('keydown', function(e) {
                    console.log("监听事件keydown：", e)
                    switch (e.keyCode) {
                        case 13:
            ...
            _createClass(PDFFindBar, [{
                ...
                value: function dispatchEvent(type, findPrev) {
                    console.log('this.findField.value:', this.findField.value);
